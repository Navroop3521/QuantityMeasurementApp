...
//        assertEquals(12.0, q.toConvert(LengthUnit.INCH).getValue(), 0.001);
//    }
//
//    @Test
//    void testGenericQuantity_WeightOperations_Conversion() {
//        Quantity<WeightUnit> q = new Quantity<>(1, WeightUnit.KILOGRAM);
//        assertEquals(1000.0, q.toConvert(WeightUnit.GRAM).getValue(), 0.001);
//    }
//
//    @Test
...
//                assertNotNull(new Quantity<>(1, u1).toConvert(u2));
//            }
//        }
...
//        assertEquals(12.0, l1.toConvert(LengthUnit.INCH).getValue(), 0.001);
//    }
//
//    // ================= APP =================
//
...
//        assertEquals(12.0,
//                new Quantity<>(1, LengthUnit.FEET)
//                        .toConvert(LengthUnit.INCH).getValue(), 0.001);
//    }
//
//    @Test
...
//        Quantity<LengthUnit> q1 = new Quantity<>(1, LengthUnit.FEET);
//        Quantity<LengthUnit> q2 = q1.toConvert(LengthUnit.INCH);
//        assertNotSame(q1, q2);
//    }
//
//    @Test
...
//        Quantity<VolumeUnit> result = original.toConvert(VolumeUnit.MILLILITRE)
...
//
//        assertEquals(a.toConvert(VolumeUnit.LITRE).getValue(),
//                b.toConvert(VolumeUnit.LITRE).getValue(), EPSILON);
//    }
//
//    @Test
...
//                 122.0,
//                 new Quantity<>(50.0, TemperatureUnit.CELSIUS)
//                         .toConvert(TemperatureUnit.FAHRENHEIT)
//                         .getValue(),
//                 0.0001
//         );
//
...
//                 0.0,
//                 new Quantity<>(32.0, TemperatureUnit.FAHRENHEIT)
//                         .toConvert(TemperatureUnit.CELSIUS)
//                         .getValue(),
//                 0.0001
//         );
//
...
//                 new Quantity<>(273.15, TemperatureUnit.KELVIN),
//                 new Quantity<>(0.0, TemperatureUnit.CELSIUS)
//                         .toConvert(TemperatureUnit.KELVIN)
//         );
//     }
//
//     @Test
...
//                 original.toConvert(TemperatureUnit.FAHRENHEIT)
//                         .toConvert(TemperatureUnit.CELSIUS);
//
//         assertEquals(
//                 original.getValue(),
